...
Reporting a bug or have a feature request? Open a ticket [here](https://github.com/nasa-jpl/mango-ingest/issues). Please make sure to search existing tickets before opening new ones to avoid duplication.

To contribute code, follow the guidelines below.

## Preparing your Fork

1. Create your own fork of `nasa-jpl/mango-ingest`

2. Clone your project: `git clone git@github.com:username/mango-ingest.git`
