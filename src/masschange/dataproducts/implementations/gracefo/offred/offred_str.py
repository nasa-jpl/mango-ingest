...
from masschange.ingest.executor.datafilereaders.gracefo.offred.offred_str import GraceFOOffredStrDataFileReader
from masschange.missions import GraceFO
from masschange.dataproducts.timeseriesdataproduct import DataProduct


class GraceFOOffredStrDataProduct(DataProduct):
    @classmethod
    def get_reader(cls) -> DataFileReader:
        return GraceFOOffredStrDataFileReader()

    mission = GraceFO
    id_suffix = 'OFFRED_STR'
