...
from masschange.ingest.datafilereaders.gracefo.primary.gracefomag1b import GraceFOMag1BDataFileReader
from masschange.missions import GraceFO
from masschange.dataproducts.timeseriesdataproduct import TimeSeriesDataProduct


class GraceFOMag1BDataProduct(TimeSeriesDataProduct):
    @classmethod
