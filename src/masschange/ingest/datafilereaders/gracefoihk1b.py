...
class GraceFOIhk1BDataFileReader(AsciiDataFileReader):
    ...
    def get_input_file_default_regex(cls) -> str:
        return '^IHK1B_\d{4}-\d{2}-\d{2}_(?P<instrument_id>[CD])_(?P<dataset_version>\d{2})\.txt$'
    ...
    def get_input_column_defs(cls) -> Collection[AsciiDataFileReaderColumn]:
        return [
            ...
            AsciiDataFileReaderColumn(index=5, name='sensortype', np_type='U1', unit=None, is_time_series_id_column=True),
