...
class GraceFOAhkBaseDataFileReader(DataFileWithProdFlagReader):
    @classmethod
    ...
    def get_input_column_defs(cls) -> Collection[AsciiDataFileReaderColumn]:
        return [
            ...
            AsciiDataFileReaderColumn(index=2, name='time_ref', np_type='U1', unit=None, const_value=cls.get_time_ref_const_value()),
