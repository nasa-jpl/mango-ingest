...
class GraceFOSca1ADataFileReader(AsciiDataFileReader):
    ...
    def get_input_column_defs(cls) -> Collection[AsciiDataFileReaderColumn]:
        ...
        return [
            ...
            AsciiDataFileReaderColumn(index=3, name='sca_id', np_type=np.ubyte, unit=None, is_channel_id_column=True),
            AsciiDataFileReaderColumn(index=4, name='sca_desig', np_type='U1', unit=None),
            AsciiDataFileReaderColumn(index=5, name='quatangle', np_type=np.double, unit=None, aggregations=['min', 'max']),
            AsciiDataFileReaderColumn(index=6, name='quaticoeff', np_type=np.double, unit=None, aggregations=['min', 'max']),
            AsciiDataFileReaderColumn(index=7, name='quatjcoeff', np_type=np.double, unit=None, aggregations=['min', 'max']),
            AsciiDataFileReaderColumn(index=8, name='quatkcoeff', np_type=np.double, unit=None, aggregations=['min', 'max']),
