...
class GraceFOGpi1ARptDataFileReader(ReportFileReader):
    @classmethod
    ...
    def get_input_file_default_regex(cls) -> str:
        return '^GPI1A_\d{4}-\d{2}-\d{2}_(?P<instrument_id>[CD])_(?P<dataset_version>\d{2})\.rpt$'
    ...
    def get_rpt_custom_input_column_defs(cls) -> Collection[AsciiDataFileReaderColumn]:
        ...
        return [
            ...
            AsciiDataFileReaderColumn(index=22, name='l1_nob', np_type=int, unit=None),
