...
from masschange.dataproducts.implementations.gracefo.rpt.acc1a_rpt import GraceFOAcc1ARptDataProduct
from tests.ingest.datasets.base import DatasetReaderTestCaseBase


class GraceFOAcc1ARptDatasetDatasetIngestTestCaseBase(DatasetReaderTestCaseBase):
    ...
    expected_table_first_rows = [
        ...
        ('ACC1A_2023-06-01_D_04.dat', 738849600, 738955915, 738838700.065924, 738946899.996034,
         ...
         8, 0, 0, 0, 0, 0, 0, 0, 0,
         datetime(2023, 5, 31, 20, 58, 20, 65924, tzinfo=timezone.utc))
    ]
