...
class GraceFOKbr1PassDatasetDatasetIngestTestCaseBase(DatasetIngestTestCaseBase):
    ...
    expected_table_first_rows = [
        ('KBR1A_2018-06-01_C_NYA_581169224.pass', 581083200, 607670129, 581169224.55, 581180684.45, 114600,
         ...
         8, 0, 0, 0, 0, 0, 0, 0, 0,
         datetime(2018, 6, 1, 23, 53, 44, 550000, tzinfo=timezone.utc)),
        ('KBR1A_2018-06-01_D_NYA_581163584.pass', 581083200, 607670151, 581163584.55, 581174984.45, 114000,
         ...
         8, 0, 0, 0, 0, 0, 0, 0, 0,
         datetime(2018, 6, 1, 22, 19, 44, 550000, tzinfo=timezone.utc))
    ]
