...
class GraceFOImu1PassDatasetDatasetIngestTestCaseBase(DatasetIngestTestCaseBase):
    ...
    expected_table_first_rows = [
        ('IMU1A_2018-06-01_C_NYA_581169228.pass', 581083200, 607670128, 581169228.003935, 581180687.879144,
         ...
         8, 0, 0, 0, 0, 0, 0, 0, 0,
          datetime(2018, 6, 1, 23, 53, 48, 3935, tzinfo=timezone.utc)),
        ('IMU1A_2018-06-01_D_NYA_581163589.pass', 581083200, 607670150, 581163589.003945, 581174988.879156,
         ...
         8, 0, 0, 0, 0, 0, 0, 0, 0,
         datetime(2018, 6, 1, 22, 19, 49, 3945, tzinfo=timezone.utc))
    ]
