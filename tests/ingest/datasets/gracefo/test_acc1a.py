...
class GraceFOAcc1ADatasetDatasetIngestTestCaseBase(DatasetIngestTestCaseBase):
    ...
    expected_table_first_rows = [
        ('C', '00000000', -1.064995712362181e-05, -1.835037928999774e-07, -2.778613076425759e-07, 1.296553015708923e-05,
         0.0001192528009414673, -0.000781349539756775, 0, 738849600007739,
         datetime(2023, 6, 1, 0, 0, 0, 7739, tzinfo=timezone.utc)),
        ('D', '00000000', -1.457772331862398e-05, 2.413741401248364e-06, -3.204377114688302e-06, 0.0001855893880128861,
         -0.00149625837802887, -0.0006985849142074586, 0, 738849600011933,
