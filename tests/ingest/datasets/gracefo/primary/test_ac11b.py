...
from masschange.dataproducts.implementations.gracefo.primary.ac11b import GraceFOAc11BDataProduct
from tests.ingest.datasets.base import DatasetReaderTestCaseBase


class GraceFOAc11BDatasetReaderTestCase(DatasetReaderTestCaseBase):
    test_data_path = './tests/input_data/test_unzipped/'
    data_is_zipped = False
    dataset_cls = GraceFOAc11BDataProduct
    expected_table_names = ['gracefo_ac11b_04_c', 'gracefo_ac11b_04_d']
