...
from masschange.dataproducts.implementations.gracefo.primary.gps1b import GraceFOGps1BDataProduct
from tests.ingest.datasets.base import DatasetReaderTestCaseBase
from typing import Union


class GraceFOGps1BDatasetReaderTestCase(DatasetReaderTestCaseBase):
    ...
    expected_table_first_rows = [
        (738849600,  0,  'C',  6,  0,
         '0000111111111111',   '00000011',  False, False, False, False, False, False, True, True,
