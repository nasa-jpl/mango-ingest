...
class GraceFOQsa1BDatasetReaderTestCase(DatasetReaderTestCaseBase):
    ...
    expected_table_first_rows = [
        (580219200, 'C', 1, -0.1846523033914243, 0.687786333034212, 0.676514247097443, 0.18756854858364,
         0, '00000000', False, False, False, False, False, False, False, False,
         datetime(2018, 5, 22, 0, 0, tzinfo=timezone.utc)),
        (580219200, 'D', 1, -0.1789388979356683, 0.682734893544669, 0.68280707751296,
         0.188754949181018, 0, '00000000', False, False, False, False, False, False, False, False,
         datetime(2018, 5, 22, 0, 0, tzinfo=timezone.utc))
    ]
