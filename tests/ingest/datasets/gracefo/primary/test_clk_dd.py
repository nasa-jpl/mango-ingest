...
class GraceFOClkDdDatasetReaderTestCase(DatasetReaderTestCaseBase):
    ...
    expected_field_types = [int, float, int, float, int, float, int, float, float, float, float, datetime]
    expected_table_row_counts = [101]
    expected_table_first_rows = [
        (738842400, 4.964719799880059e+06, 738842400, 4.964719818414857e+06, 738842400,
         5.138771403292072e+06, 738842400, 5.138771409169317e+06, -6.182543019206399e-11,
         -1.960438061887615e-11, -4.222104957318784e-11,
