...
from masschange.dataproducts.implementations.gracefo.primary.pci1a import GraceFOPci1ADataProduct
...
class GraceFOPci1ADatasetReaderTestCase(DatasetReaderTestCaseBase):
    ...
    expected_table_first_rows = [
        (738849600, 'C', 1.444398040265439, -1.043760965730422e-10, -6.875266741762771e-12, '00000000',
         False, False, False, False, False, False, False, False, datetime(2023, 6, 1, 0, 0, 0, tzinfo=timezone.utc)),
